...
// .wrangler/tmp/pages-yB31eY/functionsWorker-0.31426804372380535.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var TARGET_DOMAIN = "p01--host--8yklx28n25l4.code.run";
...
var METHODS_WITHOUT_BODY = /* @__PURE__ */ new Set(["GET", "HEAD", "OPTIONS"]);
...
__name(proxyTelegram, "proxyTelegram");
__name2(proxyTelegram, "proxyTelegram");
async function proxyTarget(request, url) {
  ...
  const upstream = await fetch(new Request(targetUrl, {
    ...
    headers: reqHeaders,
    body: METHODS_WITHOUT_BODY.has(request.method) ? void 0 : request.body,
    redirect: "manual"
  }));
  return sanitizeResponse(upstream, url);
}
__name(proxyTarget, "proxyTarget");
__name2(proxyTarget, "proxyTarget");
...
__name(sanitizeResponse, "sanitizeResponse");
__name2(sanitizeResponse, "sanitizeResponse");
...
__name(sanitizeHeaders, "sanitizeHeaders");
__name2(sanitizeHeaders, "sanitizeHeaders");
function sanitizeLocation(location, url) {
  return location.replace(new RegExp(`https?://${escapeRegex(TARGET_DOMAIN)}`, "gi"), url.origin).replace(new RegExp(escapeRegex(TARGET_DOMAIN), "gi"), url.host);
}
__name(sanitizeLocation, "sanitizeLocation");
__name2(sanitizeLocation, "sanitizeLocation");
function sanitizeText(text, url) {
  return text.replaceAll(TARGET_URL, url.origin).replaceAll(TARGET_DOMAIN, url.host);
}
...
__name(tryReadBody, "tryReadBody");
__name2(tryReadBody, "tryReadBody");
...
__name(cleanHeaders, "cleanHeaders");
__name2(cleanHeaders, "cleanHeaders");
...
// .wrangler/tmp/bundle-HBKfxT/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-HBKfxT/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.31426804372380535.js.map
